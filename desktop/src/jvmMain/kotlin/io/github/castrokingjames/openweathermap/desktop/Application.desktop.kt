 ...
 */
package io.github.castrokingjames.openweathermap.desktop
  ...
  initKoin {
    properties(
      mapOf(
        ...
        OPEN_WEATHER_MAP_API_KEY to (System.getenv(OPEN_WEATHER_MAP_API_KEY) ?: ""),
      ),
    )
  }.koin
...
fun main() {
  ...
  application {
    val component = koin.get<AppComponent>()
