...
import io.github.castrokingjames.API_GEO
import io.github.castrokingjames.datasource.remote.get
import io.github.castrokingjames.datasource.remote.response.LocationResponse
...
class LocationService constructor(
  ...
  suspend fun get(): Response<LocationResponse> {
    return httpClient
      .get<LocationResponse>(API_GEO)
  }
}
